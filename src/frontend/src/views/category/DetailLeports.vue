        ...
        <v-col>
          <v-card>
            ...
            <v-card-text class="text-h6">
              <p>주소  : {{ tours.addr1 }}</p>
              <p v-if="detailIntro.infocenterleports != ''">
                문의 및 안내 : {{ detailIntro.infocenterleports }}
              </p>
              <p v-if="detailIntro.usetimeleports != '' ">
                이용 시간 : {{ detailIntro.usetimeleports }}
              </p>
              <p v-if="detailIntro.openperiod != null ">
                개장 기간 : {{ detailIntro.openperiod }}
              </p>
              <p v-if="detailIntro.usefeeleports != '' ">
                입장료 : {{ detailIntro.usefeeleports }}
              </p>
            </v-card-text>
            <hr>
