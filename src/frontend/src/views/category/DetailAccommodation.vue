        ...
        <v-col>
          <v-card>
            ...
            <v-card-text class="text-h6">
              <p>주소  : {{ tours.addr1 }}</p>
              <p v-if="detailIntro.infocenterlodging != ''">
                문의 및 안내 : {{ detailIntro.infocenterlodging }}
              </p>
              <p v-if="detailIntro.accomcountlodging != '' ">
                수용 인원 : {{ detailIntro.accomcountlodging }}
              </p>
              <p v-if="detailIntro.checkintime != null ">
                입실 시간 : {{ detailIntro.checkintime }}
              </p>
              <p v-if="detailIntro.checkouttime != '' ">
                퇴실 시간 : {{ detailIntro.checkouttime }}
              </p>
            </v-card-text>
            <hr>
