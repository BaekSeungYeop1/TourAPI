        ...
        <v-col>
          <v-card>
            ...
            <v-card-text class="text-h6">
              <p>주소  : {{ tours.addr1 }}</p>
              <p>문의 및 안내 : {{ detailIntro.infocentershopping }}</p>
              <p v-if="detailIntro.culturecenter != null ">
                문화 센터 : {{ detailIntro.culturecenter }}
              </p>
              <p v-if="detailIntro.opentime != null ">
                영업 시간 : {{ detailIntro.opentime }}
              </p>
              <p v-if="detailIntro.restdateshopping != null ">
                쉬는날 : {{ detailIntro.restdateshopping }}
              </p>
              <p v-if="detailIntro.saleitem != '' ">
                판매 품목 : {{ detailIntro.saleitem }}
              </p>
            </v-card-text>
            <hr>
