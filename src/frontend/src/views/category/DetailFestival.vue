        ...
        <v-col>
          ...
          <v-card>
            ...
            <v-card-text class="text-h6">
              <p v-if="detailIntro.eventplace != '' ">
                행사 장소 : {{ detailIntro.eventplace }}
              </p>
              <p v-if="detailIntro.sponsor2tel != null ">
                문의 및 안내 : {{ detailIntro.sponsor2tel }}
              </p>
              <p v-if="detailIntro.agelimit != null ">
                관람가능 연령 : {{ detailIntro.agelimit }}
              </p>
              ...
              <p v-if="detailIntro.playtime != '' ">
                공연시간 : {{ detailIntro.playtime }}
              </p>
              <p v-if="detailIntro.spendtimefestival != null ">
                이용시간 : {{ detailIntro.spendtimefestival }}
              </p>
            </v-card-text>
            <hr>
